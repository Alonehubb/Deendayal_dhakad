...
PICS = (environ.get('PICS', 'https://envs.sh/AAf.jpg')).split() #SAMPLE PIC
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002215419345') # support group id ( make sure bot is admin )
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002233160226')) #Log channel id ( make sure bot is admin )
...
MSG_ALRT = environ.get('MSG_ALRT', 'you_wanthub')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/xyxmovie_hubAv') #Support group link ( make sure bot is admin )
